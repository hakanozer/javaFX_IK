...
public class ÖdemeBelirlemeController extends msDB implements Initializable {
    ...
    public void fpuanGetir(ActionEvent evt) {
        ...
        try {
            ...
            Logger.getLogger(ÖdemeBelirlemeController.class.getName()).log(Level.SEVERE, null, ex);
        }
